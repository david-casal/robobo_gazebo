...
#include "robobo/robobo_camera.h"
...
GZ_REGISTER_SENSOR_PLUGIN(RoboboCamera)

////////////////////////////////////////////////////////////////////////////////
// Constructor
RoboboCamera::RoboboCamera()
{
}
...
void RoboboCamera::Load(sensors::SensorPtr _parent, sdf::ElementPtr _sdf)
{
  ...
  // copying from CameraPlugin into RoboboCameraUtils
  ...
  RoboboCameraUtils::Load(_parent, _sdf);
}

////////////////////////////////////////////////////////////////////////////////
// Update the controller
void RoboboCamera::OnNewFrame(const unsigned char *_image,
