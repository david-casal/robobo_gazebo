...
////////////////////////////////////////////////////////////////////////////////
// Constructor
RoboboCameraUtils::RoboboCameraUtils()
{
...
void RoboboCameraUtils::configCallback(
...
////////////////////////////////////////////////////////////////////////////////
// Load the controller
void RoboboCameraUtils::Load(sensors::SensorPtr _parent,
  sdf::ElementPtr _sdf,
...
//    this->camera_name_ = this->sdf->Get<std::string>("cameraName");
  ...
  this->deferred_load_thread_ = boost::thread(
    boost::bind(&RoboboCameraUtils::LoadThread, this));
}

event::ConnectionPtr RoboboCameraUtils::OnLoad(const boost::function<void()>& load_function)
{
...
////////////////////////////////////////////////////////////////////////////////
// Load the controller
void RoboboCameraUtils::LoadThread()
{
  // Exit if no ROS
  ...
  if (!this->camera_name_.empty())
  {
    ...
    dynamic_reconfigure::Server<gazebo_plugins::GazeboRosCameraConfig>
      ::CallbackType f =
      boost::bind(&RoboboCameraUtils::configCallback, this, _1, _2);
  ...
  this->image_pub_ = this->itnode_->advertise(
    ...
    boost::bind(&RoboboCameraUtils::ImageConnect, this),
    boost::bind(&RoboboCameraUtils::ImageDisconnect, this),
    ros::VoidPtr(), true);
  ...
  if (this->CanTriggerCamera())
  {
    ros::SubscribeOptions trigger_so =
      ros::SubscribeOptions::create<std_msgs::Empty>(
          ...
          boost::bind(&RoboboCameraUtils::TriggerCameraInternal, this, _1),
          ros::VoidPtr(), &this->camera_queue_);
...
void RoboboCameraUtils::TriggerCamera()
{
}

bool RoboboCameraUtils::CanTriggerCamera()
{
  return false;
}

void RoboboCameraUtils::TriggerCameraInternal(
...
void RoboboCameraUtils::SetHFOV(const std_msgs::Float64::ConstPtr& hfov)
{
...
////////////////////////////////////////////////////////////////////////////////
// Set Update Rate
void RoboboCameraUtils::SetUpdateRate(
...
////////////////////////////////////////////////////////////////////////////////
// Increment count
void RoboboCameraUtils::ImageConnect()
{
...
////////////////////////////////////////////////////////////////////////////////
// Decrement count
void RoboboCameraUtils::ImageDisconnect()
{
  boost::mutex::scoped_lock lock(*this->image_connect_count_lock_);
...
void RoboboCameraUtils::Init()
{
  ...
  this->callback_queue_thread_ = boost::thread(
    boost::bind(&RoboboCameraUtils::CameraQueueThread, this));
...
void RoboboCameraUtils::PutCameraData(const unsigned char *_src,
...
////////////////////////////////////////////////////////////////////////////////
// Put camera_ data to the interface
void RoboboCameraUtils::PublishCameraInfo(common::Time &last_update_time)
{
  if (!this->initialized_ || this->height_ <=0 || this->width_ <=0)
    return;
...
void RoboboCameraUtils::PublishCameraInfo()
{
  if (!this->initialized_ || this->height_ <=0 || this->width_ <=0)
    return;
...
////////////////////////////////////////////////////////////////////////////////
// Put camera_ data to the interface
void RoboboCameraUtils::CameraQueueThread()
{
